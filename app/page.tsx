                ...
                >
                  ...
                  <div className="aspect-[16/9] overflow-hidden">
                    <img
                        src={
                            post.coverImage ||
                            `${process.env.NEXT_PUBLIC_BASE_PATH}/placeholder.svg?height=400&width=800`
                        }
                        alt={post.title}
        ...
        <section className="mb-12 bg-muted p-8 rounded-lg">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Por que comprar pelos nossos links?
            </h2>
            <p className="text-lg mb-6">
              Pesquisamos e testamos produtos para trazer sempre as melhores
              recomendações. Comprando pelos nossos links, você apoia nosso site
            ...
            {categories
                ...
                .map((category) => (
                    ...
                    >
                      ...
                      <span className="relative text-lg font-semibold text-white drop-shadow-[0_2px_3px_rgba(0,0,0,0.8)]">
                  {category.name}
                </span>
                    </Link>
                ))}
